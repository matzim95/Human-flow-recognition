...
input = "videos/example_01.mp4"  # path to optional input video file
...
goturnprototxt = "tracker/goturn.prototxt"  # path to Caffe 'deploy' prototxt file
goturnmodel = "tracker/goturn.caffemodel"  # path to Caffe pre-trained model
